...
export default class Controller {
  ...
  addSubscribe(element) {
    ...
    element.addEventListener("click", this.onClickReverseButton.bind(this));
    element.addEventListener("click", this.onClickCountButton.bind(this));
  ...
  onClickReverseButton(e) {
    if (!e.target.classList.contains("button__reverse")) {
      return;
    }
    e.preventDefault();
    const departureText = document.querySelector(".input__from").value;
    const arrivalText = document.querySelector(".input__to").value;

    document.querySelector(".input__from").value = arrivalText;
    document.querySelector(".input__to").value = departureText;
  }

  onClickCountButton(e) {
    if (e.target.classList.contains("count__button")) {
      e.preventDefault();
      console.log("Добавь счётчик!");
    }
  }
